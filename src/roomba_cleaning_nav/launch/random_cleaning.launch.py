"""Launch file for the random cleaning walk node.

Usage (once the workspace is built and sourced):

    ros2 launch roomba_cleaning_nav random_cleaning.launch.py
...
def generate_launch_description() -> LaunchDescription:
    ...
    random_cleaning_node = Node(
        package="roomba_cleaning_nav",
        executable="random_cleaning_node",
        name="random_cleaning_node",
