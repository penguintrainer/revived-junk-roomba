"""Launch file for the autonomous cleaning session node.
...
def generate_launch_description() -> LaunchDescription:
    ...
    autonomous_cleaning_node = Node(
        package="roomba_autonomous_cleaning",
        executable="autonomous_cleaning_node",
        name="autonomous_cleaning_session_node",
